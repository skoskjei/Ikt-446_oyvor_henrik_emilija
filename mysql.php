<?php
include_once 'MySQL/mysqlOlap.php';
$query = new MySQLOlap();
...
<script>
    ...
    function renderTable_1() {
        ...
        let url = `/MySQL/table1.php?yeartb1=${yearTb1}&statetb1=${stateTb1}`
        //console.log(url);
    ...
    function renderTable_3() {
        ...
        $.get(`/MySQL/table3.php?yeartb3=${yearTb3}&disease=${disease}&statetb3=${stateTb3}`, function (result) {
            let data = [];
            const dataTable2 =[];
