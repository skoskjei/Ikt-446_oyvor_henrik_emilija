<?php
include_once 'Neo4j/neo4jOlap.php';
$query = new Neo4jOlap();
...
<script>
    ...
    function renderTable_1() {
        ...
        let url = `/Neo4j/table1.php?yeartb1=${yearTb1}&statetb1=${stateTb1}`
        //console.log(url);
    ...
    function renderTable_3() {
        ...
        $.get(`/Neo4j/table3.php?yeartb3=${yearTb3}&disease=${disease}&statetb3=${stateTb3}`, function (result) {
            let data = [];
            const dataTable2 =[];
